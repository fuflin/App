...
<button class="btn btn-dark" style="display: flex; justify-content: center; margin: auto; margin-bottom: 30x;"><a style="color: white;" href="index.php?action=pageAjoutCasting">ADD Casting</a></button>
